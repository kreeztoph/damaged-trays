...
def main():
    ...
    try:
        ...
        with cols1:
            st.subheader("📋 Latest PLC Data in Real-Time ")
            if not plc_df.empty:
        ...
        with cols4:
            st.subheader("📦 Scanned Tray Insights in Real-Time ")
        ...
        fig_defect.update_layout(
            title="NOTE: Data is currently 24 hours behind, at midnight of the *current* day the *previous* day will update",
            xaxis_title="Date",
